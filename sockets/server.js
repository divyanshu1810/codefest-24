...
const wssocket = new WebSocket('https://4s25rzr5-8080.inc1.devtunnels.ms/');
const app = express();
...
io.on('connect', socket => {
    ...
    socket.on('sendStream', ({stream, room}) => {
        ...
        const dataToSend = 'Hello, ML WebSocket!';
        wssocket.send(JSON.stringify({message: dataToSend, stream: streamstr, room: room}));
      });
})
